package yaboichips.mightymachines.common.gui;
...
public class EnergyBar {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MightyMachines.MOD_ID, "textures/gui/energy_bar.png");
